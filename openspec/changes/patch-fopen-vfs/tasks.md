...
**Task 1: LoadRom — copy buffer to LocalFolder temp file**
...
**Task 2: Handle ROM filename from picker**
...
**Task 3: Temp file cleanup on unload**
...
**Task 5: Config & persistent files directory**
...
**Task 7: Build and test full cycle**
